...
*   Edits by:   Socks
*	Descrp	:	Added blocking changes if survivors are out of the spawn room (admin can override)
...
public Action NickUse(int client, int args)
{
	...
	{
		ReplyToCommand(client, "[SCS] You cannot change character if anyone has left the safe room!");
